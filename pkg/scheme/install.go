// https://github.com/kubernetes/kubernetes/blob/master/pkg/kubectl/scheme/install.go
...
func init() {
	...
	utilruntime.Must(Scheme.SetVersionPriority(admissionv1beta1.SchemeGroupVersion))
